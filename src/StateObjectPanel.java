...
{		
	...
	{	
        ...
        _start = new JButton();
        // Start State icon
        ImageIcon startIcon = new ImageIcon(getClass().getResource("start.gif"));
    	...
    	_startA = new JButton();
    	// Start accept Icon
        ImageIcon startAIcon = new ImageIcon(getClass().getResource("startA.gif"));
        ...
        ImageIcon intermediateIcon = new ImageIcon(getClass().getResource("intermediate.gif"));
    	...
    	_accept = new JButton();
    	// Accept Icon
        ImageIcon acceptIcon = new ImageIcon(getClass().getResource("accept.gif"));
	...
	// POST: The buttons are either disbaled or enabled 
